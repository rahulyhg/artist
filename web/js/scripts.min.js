...
$(function(){$(".gallery__carousel").owlCarousel({center:!0,items:3,loop:!0,margin:50,smartSpeed:600,nav:!0,navText:["Назад","Вперед"],dots:!0,responsive:{0:{margin:10,items:1,dots:!1},480:{margin:10,items:2},1200:{items:3}}}),$(".mass-media__news-text-wrap").equalHeights(),$(".header__audio").audioPlayer(),$(".header__musiclist").click(function(a){a.preventDefault(),$(".overlay").fadeIn(400,function(){$(".musiclist__popup").css("display","block").animate({opacity:1,top:"100px"},200)})}),$(".header__video1").click(function(a){a.preventDefault(),$(".overlay").fadeIn(400,function(){$(".video__popup1").css("display","block").animate({opacity:1,top:"100px"},200)})}),$(".close, .overlay").click(function(){$(".musiclist__popup, .video__popup1").animate({opacity:0,top:"50px"},200,function(){$(this).css("display","none"),$(".overlay").fadeOut(400)})}),$(".loading").delay(0).fadeOut("slow",function(){$(".preloader").fadeOut("slow")}),$(".header__bottom-right-text").on("click",function(a){$("html,body").stop().animate({scrollTop:$("#scrollto").offset().top},700),a.preventDefault()}),$(".header__center-button-wrap a").on("click",function(e){e.preventDefault()});$(".zoom-gallery").magnificPopup({delegate:"a",type:"image",closeOnContentClick:!1,closeBtnInside:!1,mainClass:"mfp-with-zoom mfp-img-mobile",image:{verticalFit:!0},gallery:{enabled:!0},zoom:{enabled:!0,duration:300,opener:function(e){return e.find("img")}}});$(".event__slider").owlCarousel({items:1,loop:!0,margin:50,smartSpeed:500,nav:!0,dots:!1,navText:["Назад","Вперед"]});});